...
```bash
npx shadcn@latest add http://localhost:3000/r/wuhan/execution-result-01.json
```
...
<ComponentSource name="execution-result-demo" title="registry/wuhan/examples/execution-result/execution-result-demo.tsx" />
